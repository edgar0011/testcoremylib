...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      filename: 'index.html',
      inject: 'body',
      title: 'Diana Biotechnologies',
      description: 'Diana Biotechnologies, COVID-19 testing monitoring',
      keywords: 'Diana Biotechnologies, COVID-19, testing, monitoring, SARS-COV2, vaccine, vaccination',
